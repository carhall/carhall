class Category::Area < ActiveEnum::Base
  AreaMap = {
    ...
    "吉林省" => %w(长春 白城 白山 吉林 辽源 四平 通化 松原 延边(延吉) 珲春 龙井 舒兰 临江 公主岭 梅河口 德惠 九台 榆树 磐石 蛟河 桦甸 洮南 大安 双辽 集安 图们 敦化 和龙), 
    ...
    "四川省" => %w(成都 内江 峨眉山 绵阳 宜宾 泸州 攀枝花 自贡 资阳 崇州 西昌 都江堰 遂宁 乐山 达州 江油 大邑 金堂 德阳 南充 广安 广元 巴中 雅安 眉山 阿坝(马尔康) 甘孜(康定) 三台 丹棱 梁平 万县 广汉 汶川县 什邡 彭州 绵竹 邛崃 阆中 华蓥 万源 简阳), 
    "贵州省" => %w(贵阳 安顺 铜仁 六盘水 遵义 毕节 兴义 凯里 都匀 福泉 仁怀 赤水 清镇), 
    "云南省" => %w(昆明 西双版纳 大理 德宏(潞西) 思茅 玉溪 曲靖 保山 昭通 临沧 丽江 文山 个旧 楚雄 迪庆(香格里拉) 宜良 沅江 安宁 宣威 瑞丽 开远 景洪), 
    "西藏自治区" => %w(拉萨 那曲 昌都 山南 日喀则 阿里(噶尔) 林芝), 
    "陕西省" => %w(西安 宝鸡 延安 兴平 咸阳 铜川 渭南 汉中 榆林 安康 商洛 周至 韩城 华阴), 
    "甘肃省" => %w(兰州 嘉峪关 酒泉 临夏 白银 天水 武威 张掖 平凉 庆阳 定西 陇南(成县) 甘南(合作) 敦煌 金昌 玉门), 
    "青海省" => %w(西宁 海东(平安) 海北(海晏) 黄南(同仁) 海南(共和) 果洛(玛沁) 海西(德令哈) 玉树 格尔木), 
    "内蒙古自治区" => %w(呼和浩特 呼伦贝尔(海拉尔) 包头 赤峰 鄂尔多斯 巴彦淖尔盟(临河) 阿拉善盟(阿拉善左旗) 兴安盟(乌兰浩特) 通辽 乌海 乌兰察布盟(集宁) 锡林郭勒盟(锡林浩特) 满洲里 扎兰屯 牙克石 根河 额尔古纳 阿尔山 霍林郭勒 二连浩特 丰镇), 
