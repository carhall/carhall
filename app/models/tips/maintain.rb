class Tips::Maintain < ActiveRecord::Base
	include Tips::Servicable
  set_order_class Tips::MaintainOrder
  ...
  validates_presence_of :title, :maintain_type_id, :price, :vip_price

  def to_base_builder
    Jbuilder.new do |json|
      json.extract! self, :id, :title, :area_id, :area,
        :maintain_type_id, :ticket_type, :price, :vip_price, 
