class Accounts::Wechat <  Accounts::Account
   ...
   # has_many :mending_orders, class_name: 'Tips::MendingOrder', foreign_key: "user_id"
     has_many :mending_orders,-> { where("cleaning_type_id = 5")}, class_name: 'Tips::CleaningOrder', foreign_key: "user_id"
    ...
    has_many :cleaning_orders,-> { where("cleaning_type_id = 1")}, class_name: 'Tips::CleaningOrder', foreign_key: "user_id"
