class Accounts::RegistrationsController < Devise::RegistrationsController
  ...
  def account_params
    ...
    permit = [:mobile, :current_password, :password, :password_confirmation, 
      ...
      :weixin_app_id, :weixin_app_secret, :weixin_welcome,:weixin_open_id,:weixin_image,:region_id,:is_activate]
    ...
    when "Accounts::Dealer"
      ...
      permit << {detail_attributes: [:id, :dealer_type_id, :specific_service_id, 
        ...
        :authentication_image, :rescue_phone, :insurance_phone, 
        :secondhand_appraise_phone, :postsale_phone, :test_drive_phone, 
